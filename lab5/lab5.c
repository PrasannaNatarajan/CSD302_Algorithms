...
mat multiply (mat m1, mat m2){
    ...
    C.row_start = (m1.row_end+m1.row_start)/2 + 1;
    C.row_end = m1.row_end;
    C.col_start = m1.col_start;
    C.col_end = (m1.col_end + m1.col_start)/2;

    D.row_start = (m1.row_end + m1.row_start)/2 + 1;
    D.row_end = m1.row_end;
    D.col_start = (m1.col_end + m1.col_start)/2 + 1;
    D.col_end = m1.col_end;

    E.row_start = m2.row_start;
    E.row_end = (m2.row_end + m2.row_start)/2;
    E.col_start = m2.col_start;
    E.col_end = (m2.col_end + m2.col_start)/2;

    F.row_start = m2.row_start;
    F.row_end = (m2.row_end + m2.row_start)/2;
    F.col_start = (m2.col_end + m2.col_start)/2 + 1;
    F.col_end = m2.col_end;

    G.row_start = (m2.row_end + m2.row_start)/2 + 1;
    G.row_end = m2.row_end;
    G.col_start = m2.col_start;
    G.col_end = (m2.col_end + m2.col_start)/2;
